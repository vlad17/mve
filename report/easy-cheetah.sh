...
python cmpc/main_cmpc.py delta --verbose --exp_name delta --env_name hc-easy --onpol_iters 20 --seed 1 5 10 15
python cmpc/main_cmpc.py zero --verbose --exp_name zero --env_name hc-easy --onpol_iters 20 --seed 1 5 10 15
python cmpc/main_mpc.py --verbose --exp_name mpc --env_name hc-easy --onpol_iters 20 --seed 1 5 10 15
python cmpc/main_random_policy.py --verbose --exp_name random --env_name hc-easy --num_paths 20 --seed 1 5 10 15
