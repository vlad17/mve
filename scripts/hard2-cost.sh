...
python mpc_bootstrap/main.py mpc --onpol_iters 20 --exp_name mpc-hard2  --seed 1 5 10 --env_name hc-hard --mpc_horizon 50
python mpc_bootstrap/main.py delta_bootstrap --onpol_iters 20 --exp_name deterministic-hard2 --seed 1 5 10 --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --explore_std 0 --env_name hc-hard --mpc_horizon 50
python mpc_bootstrap/main.py gaussian_bootstrap --onpol_iters 20 --exp_name stochastic-hard2 --seed 1 5 10 --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --env_name hc-hard --mpc_horizon 50
python mpc_bootstrap/main.py gaussian_bootstrap --onpol_iters 20 --exp_name pure-hard2 --seed 1 5 10 --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --no_extra_explore --env_name hc-hard --mpc_horizon 50
