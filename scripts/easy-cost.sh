...
python mpc_bootstrap/main.py --onpol_iters 15 --agent mpc --exp_name mpc-easy  --seed 1 5 10 --time --env_name hc-easy
python mpc_bootstrap/main.py --onpol_iters 15 --agent bootstrap --exp_name deterministic-easy --seed 1 5 10 --time --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --explore_std 0 --deterministic_learner --env_name hc-easy
python mpc_bootstrap/main.py --onpol_iters 15 --agent bootstrap --exp_name stochastic-easy --seed 1 5 10 --time --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --env_name hc-easy
python mpc_bootstrap/main.py --onpol_iters 15 --agent bootstrap --exp_name pure-easy --seed 1 5 10 --time --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --no_extra_explore --env_name hc-easy
