...
python mpc_bootstrap/plot.py \
    ...
    "data/stochastic-easy_hc-easy:RewardMSE:Gaussian BMPC" \
    "data/pure-easy_hc-easy:RewardMSE:No-explore BMPC" \
    --outfile report/easy-RewardMSE.pdf --yaxis "reward MSE"
#     'data/deterministic-easy_hc-easy:RewardMSE:$\delta$-BMPC' \
python mpc_bootstrap/plot.py \
    "data/mpc-easy_hc-easy:AverageRewardBias:MPC" \
    "data/stochastic-easy_hc-easy:AverageRewardBias:Gaussian BMPC" \
    "data/pure-easy_hc-easy:AverageRewardBias:No-explore BMPC" \
    --outfile report/easy-AverageRewardBias.pdf --yaxis "reward MSE"
