...
python mpc_bootstrap/main.py --onpol_iters 15 --agent mpc --exp_name mpc-com-easy --seed 1 5 10 --time --com_pos --com_vel --easy_cost
python mpc_bootstrap/main.py --onpol_iters 15 --agent bootstrap --exp_name bmpc-com-easy --seed 1 5 10 --time --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --deterministic_learner --com_pos --com_vel --easy_cost
python mpc_bootstrap/main.py --onpol_iters 15 --agent bootstrap --exp_name sbmpc-com-easy --seed 1 5 10 --time --con_depth 5 --con_width 32 --con_epochs 100 --con_learning_rate 1e-3 --con_batch_size 512 --com_pos --com_vel --easy_cost
