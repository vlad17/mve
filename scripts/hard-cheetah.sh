...
python mpc_bootstrap/main_bootstrapped_mpc.py ddpg --verbose --exp_name bmpc-ddpg --con_epochs 10 --onpol_iters 30 --seed 1 5 10 --con_width 64 --con_depth 2 --con_learning_rate 1e-4 --critic_lr 1e-4  --warmup_iterations_mpc 50 --action_noise_exploration 0.1 --onpol_paths 10

python mpc_bootstrap/main_mpc.py --verbose --exp_name mpc --onpol_iters 30 --seed 1 5 10  --warmup_iterations_mpc 50  --onpol_paths 10

# note ddpg does 1 rollout / iter, hence the diff in numbers
python mpc_bootstrap/main_ddpg.py --verbose --exp_name ddpg --training_batches 4000 --seed 1 5 10 --con_width 64 --con_depth 2 --con_learning_rate 1e-4 --critic_lr 1e-4  --warmup_iters 500 --onpol_paths 1 --onpol_iters 300 --log_every 10
